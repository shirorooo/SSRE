<?php
    ...
    $orderDetail = $task->newOrders($currentPage);
    $pages = ceil($allNewOrders / 25);
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                              <li><a class="dropdown-item" href="#"><?= $allNewOrders?> New Orders</a></li>
    ...
    <section id="table">
        <div class="container">
            ...
            ?>
                    <nav id="pagination">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=1">1</a></li>
                            <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=2">2</a></li>
                        </ul>
                    </nav>
            <?php
                } elseif($pages >= 3) { 
            ...
            ?>
                        <nav id="pagination">
                            <ul class="pagination">
                                <li class="page-item">
                                    <a class="page-link" href="admin-newOrders.php?page=<?= $previousPage ?>" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=<?= $previousPage ?>"><?= $previousPage ?></a></li>
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=<?= $currentPage; ?>" style="background: lightgrey;"><?= $currentPage ?></a></li>
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=<?= $nextPage; ?>"><?= $nextPage; ?></a></li>
                                <li class="page-item">
                                    <a class="page-link" href="admin-newOrders.php?page=<?= $nextPage ?>" aria-label="Next">
            ...
            ?>
                        <nav id="pagination">
                            <ul class="pagination">
                                ...
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=<?= $previousPage ?>"><?= $previousPage ?></a></li>
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=<?= $currentPage; ?>"><?= $currentPage ?></a></li>
                            </ul>
                        </nav>
            <?php
            ...
            ?>
                        <nav id="pagination">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=1">1</a></li>
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=2" >2</a></li>
                                <li class="page-item"><a class="page-link" href="admin-newOrders.php?page=3">3</a></li>
                                <li class="page-item">
                                    <a class="page-link" href="admin-newOrders.php?page=<?= $nextPage ?>" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
